...
<div class="pd-10">
    ...
    <p>
      <ul>
        <li>App Name : Cloud Network | MikroTik Hotspot Monitor</li>
        <li>Author : <a style="text-decoration: underline;" href="https://fb.com/nazmul.islam.it" target="_blank">Nazmul Islam</a></li>
        <li>Licence : <a href="#">MIT</a></li>
        <li>Website : <a style="text-decoration: underline;" href="https://nazmulham.github.io/" target="_blank">https://nazmulham.github.io</a></li>
      </ul>
    </p>
    <p><h3>lib :</h3>
      <ul>
    ...
    <div>
        <i>Copyright &copy; 2017 -'.date("Y").' Nazmul Islam</i>
    </div>
</div>    
    ';
